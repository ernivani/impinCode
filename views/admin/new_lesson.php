...
<body class="text-gray-800 font-inter bg-neutral-950 min-h-screen">
    ...
    <a href="<?= $path('admin_units', ['id' => $unitId]) ?>" class="absolute top-4 left-4 bg-gray-800 hover:bg-gray-700 text-white p-2 rounded-full">
                ...
                <div class="max-w-4xl mx-auto">
                    ...
                    <?php foreach ($lessons as $lesson): ?>
                        <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg mt-6">
                            <div class="p-6">
                                <h2 class="text-lg font-semibold text-white"><?= htmlspecialchars($lesson->getTitle()) ?></h2>
                                <div class="mt-6">
                                    <a href="<?= $path('admin_questions', ['id' => $lesson->getId()]) ?>" class="text-blue-500 hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
