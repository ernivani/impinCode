...
<body class="text-gray-800 font-inter bg-neutral-950 min-h-screen">
    <a href="<?= $path('admin_sections', ['id' => $sectionId]) ?>" class="absolute top-4 left-4 bg-gray-800 hover:bg-gray-700 text-white p-2 rounded-full">
                    ...
                    <?php foreach ($units as $unit): ?>
                        <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg mt-6">
                            <div class="p-6">
                                ...
                                <a href="<?= $path('admin_lesson', ['id' => $unit->getId()]) ?>" class="text-blue-500 hover:text-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                                    Ajouter une course
                                </a>
                            </div>
                        </div>
