<div class="flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-neutral-900 p-4 transition-all duration-200 ease-in-out -translate-x-64">
            ...
            <div class="space-y-8">
                <div>
                    <ul class="mt-3">
                        <li class="rounded-lg mb-3 last:mb-0 transition duration-150 <?php if ($page !== 'learn') : ?>hover:<?php endif ?>bg-slate-800">
                        ...
                        <li class="rounded-lg mb-3 last:mb-0 transition duration-150 <?php if ($page !== 'profile') : ?>hover:<?php endif ?>bg-slate-800">
                        ...
                        <li class="rounded-lg mb-3 last:mb-0 transition duration-150 <?php if ($page !== 'settings') : ?>hover:<?php endif ?>bg-slate-800">
