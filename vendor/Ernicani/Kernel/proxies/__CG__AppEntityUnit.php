...
class Unit extends \App\Entity\Unit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'ordre', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'section', '' . "\0" . 'App\\Entity\\Unit' . "\0" . 'lessons'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTitle(string $title): \App\Entity\Unit
    {
     ...
     * {@inheritDoc}
     */
    public function setOrdre(int $ordre): \App\Entity\Unit
    {
